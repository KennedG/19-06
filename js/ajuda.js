...
<:download:910474079931338813> No total de **154** Comandos.
...
msg.edit({embeds: [embed_1]})
   ...
   '`Avatar|Playstore|Clear|Lembrete|Ms|Say|Userinfo|Serverinfo|Infobot|Status|Uptime|Bigtext|Gerarsenha|Cpu|Emoji|Banner|Anuncio|Calculadora|Traduzir|Addemoji|Google|Filme|`', true)
msg.edit({embeds: [embed_1]})
	...
	.addField('⚒️ Comandos Moderação:',  
            '`Warn | Warns/warnings | removerwarn | |Ban | Unban | Unbanall | Voicekick | Antilink | Lock | Unlock | Setnick | Addcargo | Removecargo | Lockall | Unlockall | Roleinfo | Contador | Autorole |`', true) 
